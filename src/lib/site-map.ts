...
export const SITE_SECTIONS: SiteSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/resheniya/stomatologii", name: "Стоматологии" },
      { href: "/resheniya/okna", name: "Окна и рольставни" },
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/seo/semanticheskoe-yadro", name: "Семантическое ядро" },
      { href: "/seo/raskrutka-sayta", name: "Раскрутка сайта" },
      { href: "/seo/audit-sayta", name: "Аудит сайта" },
      { href: "/seo/yandex-karty", name: "Яндекс Карты и 2ГИС" },
      { href: "/seo/prodvizhenie-na-ozon", name: "Продвижение на Ozon" },
      { href: "/seo/prodvizhenie-na-wildberries", name: "Продвижение на Wildberries" },
      ...
      { href: "/seo/vs-megaindex", name: "INSONT и MegaIndex" },
      { href: "/seo/vs-topvisor", name: "INSONT и Топвизор" },
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/geo/kak-popast-v-gigachat", name: "Как попасть в GigaChat" },
      { href: "/geo/chatgpt", name: "ChatGPT" },
      { href: "/geo/perplexity", name: "Perplexity и Claude" },
