...
export const metadata: Metadata = {
  ...
  description:
    "Как INSONT собирает посадочные: одно намерение — один URL, город где вы работаете, перелинковка от справки к услуге. Без клонов на всю страну.",
  keywords: [
    "посадочные страницы",
  ...
  openGraph: {
    title: "Посадочные страницы — INSONT",
    description:
