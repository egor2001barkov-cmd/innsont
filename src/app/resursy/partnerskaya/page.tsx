...
export const metadata: Metadata = {
  ...
  description:
    "Привели компанию в INSONT — 20% с её оплат 12 месяцев. Выплата от 1 000 ₽ на расчётный счёт. Для агентств и фрилансеров. Без саморефералов.",
  alternates: { canonical: "/resursy/partnerskaya" },
  openGraph: {
    title: "Партнёрская программа INSONT",
    description:
        ...
        data={[
          {
            ...
            "@type": "WebPage",
            name: "Партнёрская программа INSONT",
      ...
      <article className="mx-auto max-w-[900px] px-5 py-14">
        ...
        <ol className="mt-6 space-y-5">
          {[
            ...
            [
              ...
              "Обычный путь: клиент платит INSONT, мы отдаём вам 20% с каждого счёта год. Путь агентства: клиент платит вам, вы нам — процент тот же, от нашей части.",
            ],
            [
        ...
        <div className="mt-6 grid gap-4 md:grid-cols-2">
          {[
            [
              "SEO-агентство",
              "Клиенту нужен кабинет, а вам не хочется держать ещё двух копирайтеров. Ставите кабинет под своим брендом, ведёте стратегию, тексты и очередь делает INSONT.",
            ],
            [
              "Фрилансер",
        ...
        <div className="mt-6 grid gap-3 md:grid-cols-2">
          <div className="card p-5">
            ...
            <ul className="mt-3 space-y-2 text-sm leading-relaxed">
              ...
              <li>Кабинет под вашим брендом: клиент не видит INSONT</li>
